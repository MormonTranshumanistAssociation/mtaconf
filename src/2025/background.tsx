			...
			<div className="max-w-max lg:max-w-7xl mx-auto">
				<div className="relative z-10 mb-4 md:mb-2 md:px-6">
					<div className="text-base max-w-prose lg:max-w-none">
						<h2 className="leading-6 text-orange-400 font-semibold tracking-wide uppercase">
							Background
						</h2>
						<p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-green-600 sm:text-4xl">
							Advances in Neuroscience and Cognitive Therapies
						</p>
					</div>
				</div>
					...
					<div className="lg:grid lg:grid-cols-2 lg:gap-6">
						...
						<div className="prose prose-indigo text-green-600 pt-4 lg:pt-0 lg:max-w-none flex flex-col gap-4 leading-7 hyphens-none break-words whitespace-pre-line">
							...
							<p>
								...
								we presently inhabit and is achieved through a deep
								understanding and mastery of the relevant scientific and moral
								laws, with the help of God, whose constant grace makes this
								ongoing progress possible. Diligent study of human arts and
							...
							<blockquote className="border-l-4 border-green-500 pl-4 text-xl text-green-600 font-semibold italic my-4">
								...
								so, worlds without end. It is just so with us.” (Wilford
