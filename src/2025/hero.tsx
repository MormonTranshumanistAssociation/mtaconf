          ...
          <div className="flex flex-col gap-6 sm:gap-0 sm:flex-row items-center sm:items-start sm:justify-between mx-10 pt-20 sm:pt-6 min-h-[500px] px-10">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-6 pb-6 rounded-xl sm:rounded-none sm:bg-transparent">
                ...
                >
                  <img
                    className="h-36 w-auto hidden sm:block drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] sm:drop-shadow-none"
                    src="/img/2025/mta-logo.svg"
                    alt="Mormon Transhumanist Association"
                  />
                  <img
                    className="h-36 w-auto block sm:hidden drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]"
                    src="/img/2025/mta-logo-yellow.svg"
                    alt="Mormon Transhumanist Association"
                  />
                </a>
              </div>
              <div className="grid grid-rows-3 gap-4 lg:grid-rows-1 lg:grid-cols-3 justify-items-stretch -mx-4 pb-8 lg:min-w-[38rem] lg:mr-4">
                <Portrait
